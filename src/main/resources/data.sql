...
1,
"The water from the catchment is used for drinking by the individuals, flora and fauna. It\'s also used for residential and industrial purposes, irrigation as well as for leisure. <highlight>Wildlife relies upon catchments for breeding sites, food and asylum</highlight>. Catchments are significant in ecological, financial, and social terms.",
2,
true,
...
"",
11,
"<highlight>Things that are hazardous to pour down a sink shouldn\'t be flushed down the latrine, dumped in a tempest channel or covered in your yard</highlight>, either. On the off chance that they are, the hazardous substances can even now advance into the groundwater.\\nSource: Melbourne Water, Yarra Valley Water and Readers Digest",
6,
false,
...
"",
2,
"<highlight>Water gets polluted because of the harmful substances that enter these waterbodies</highlight>. These toxic substances diffuse in them or remains hanging in them or settles on the waterbeds due to which the quality of water is deteriorated. This is not only <highlight>harmful for the marine life and aquatic ecosystem</highlight> but also these substances seep through and make their way to the groundwater which eventually ends up at our households as impure or adulterated water. We then use this impure water for our day to day chores and not to forget we also end up drinking the same impure water.\\n<fun>\"Fresh water on earth is only 2.5% of the total water when 70% of the earth\'s surface is covered by water.\"</fun>",
7,
false,
null,
"left");
...
"Household",
2,
"Most of the issues encountered by sewage treatment plants start with the material that we individuals tip down the drain or flush down the latrine at home. For instance, the sanitary napkins used by the females, wet wipes or the diapers that are used for the kids are flushed down the toilet. <highlight>Treatment plants are not that intelligent enough and neither are they equipped for treating a significant number of these wastes</highlight> and some pass through the plants untreated.",
9,
true,
...
"Treatment Plants",
5,
"Just like the sewers, even the <highlight>treatment plant has the possibility of breaking down</highlight>. Nonetheless, they are commonly planned with enough back-up frameworks to forestall any significant water contamination issues. Current treatment plants treat sewage to a phase where it is protected to deliver once again into the nature and these recycled sewages are utilised at its best.",
9,
false,
...
"",
8,
"Since stormwater isn\'t dealt with, this framework is <highlight>liable for conveying a great part of the trash or waste found along our streams and seashores</highlight>. Stormwater drains are likewise ordinarily accountable for conveying either intentionally or unintentionally spilled poisonous synthetic compounds, oils and different materials into the waterways.",
9,
false,
null,
"left");
...
2,
"The revelation of gold in 1851 made Melbourne probably the most extravagant city on earth. With a populace of about a large portion of a million people by the 1880s, it had likewise become Australia\'s greatest city. \\nYet, Melbourne was confronting a major contamination issue. While it had been depicted by British columnists as \"a city of glorious expectations\", it was additionally being named <highlight>Marvelous \'Smellbourne\' due to the city\'s unsanitary garbage removal techniques</highlight>.",
12,
true,
null,
"left");
